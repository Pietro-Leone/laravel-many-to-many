      ...
      <div class="card mt-5">
        <div class="card-header">
          <div class="d-flex justify-content-between">
            ...
            <a class="nav-link d-flex align-items-center" href="{{ Route('admin.projects.edit', $project->slug)}}"><i
                class="fa-solid fa-pen-to-square me-1"></i>Modifica</a>
          </div>
          <div class="d-flex pt-2">
            <div class="row">
              <div class="col-12 col-md-4 text-center"><img class="w-100 object-fit-cover" src="{{ asset('storage/' .
                  $project->thumb) }}"
                alt="{{ $project->title }}">
              </div>
                  ...
                  <div>
                    <div class="d-flex">
                      ...
                      <div class="d-flex">
                        ...
                        <div class="me-2">{{$technology->name}},</div>
                        @endforeach
                      </div>
                    </div>
                  </div>
